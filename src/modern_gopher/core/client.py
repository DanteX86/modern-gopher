...
import json
import hashlib
from typing import List, Optional, Iterator, Union, BinaryIO, Dict, Any, Tuple
from io import BytesIO
import logging
from datetime import datetime, timedelta

from .protocol import request_gopher_resource, save_gopher_resource, DEFAULT_GOPHER_PORT
...
class GopherClient:
    ...
    def _store_in_memory_cache(self, url: Union[str, GopherURL], content: Any) -> None:
        ...
        # Clean cache if it gets too big (simple strategy: remove oldest entries)
    ...
    def _store_in_disk_cache(self, url: Union[str, GopherURL], content: Any) -> None:
        ...
        try:
            ...
            if self.cache_ttl > 0:
                metadata['expires'] = (datetime.now() + timedelta(seconds=self.cache_ttl)).isoformat()
    ...
    def get_resource(self, url: Union[str, GopherURL], 
        ...
        # If type is specified in the URL, use it; otherwise, assume it's a directory
