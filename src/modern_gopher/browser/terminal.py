...
class GopherBrowser:
    ...
    def __init__(
        ...
        # Links extracted from HTML content
        self.extracted_html_links: List[Dict[str, str]] = []
    ...
    def _determine_context(self) -> KeyContext:
        ...
        # 2. Content context - when viewing text/binary content (no directory
        # items)
    ...
    def toggle_bookmark(self):
        ...
        if self.bookmarks.is_bookmarked(self.current_url):
            ...
            # Use the title from the selected item if available, otherwise use
            # URL
            ...
            if isinstance(content, list):
                ...
                if is_html and not processing_info:
                    try:
                        ...
                        self.status_bar.text = f"HTML content rendered ({
                            len(extracted_links)} links found)"
