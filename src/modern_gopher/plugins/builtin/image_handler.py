...
from ..base import ItemTypeHandler
...
class ImageHandler(ItemTypeHandler):
    ...
    def can_handle(self, item_type: GopherItemType,
    ...
    def process_content(self,
                        ...
                        content: Union[str,
                                       bytes],
                        item: Optional[GopherItem] = None) -> Tuple[str,
                                                                    Dict[str,
                                                                         Any]]:
    ...
    def _get_image_dimensions(self,
                              content: bytes,
                              image_format: str) -> Tuple[Optional[int],
                                                          Optional[int]]:
