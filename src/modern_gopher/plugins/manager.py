...
from .base import BasePlugin, PluginRegistry, ItemTypeHandler, ContentProcessor, ProtocolExtension
...
class PluginManager:
    ...
    def initialize(self) -> None:
        ...
        try:
            ...
            logger.info(f"Plugin system initialized with {len(self.registry.get_all_plugins())} plugins")
