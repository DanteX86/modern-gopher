...
class PluginManager:
    ...
    def process_content(self, item_type: GopherItemType, content: Any) -> Tuple[Any, Dict[str, Any]]:
        """
    ...
    def get_plugin_info(self) -> Dict[str, Any]:
        ...
        # Return empty dict for now, will be implemented with full plugin system
        return {}
