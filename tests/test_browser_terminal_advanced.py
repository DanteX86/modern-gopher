...
class TestGopherBrowserAdvancedFunctionality:
    ...
    @patch('modern_gopher.browser.terminal.BookmarkManager')
    @patch('modern_gopher.browser.terminal.KeyBindingManager')
    def test_init_with_plugin_manager_error(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.BookmarkManager')
    @patch('modern_gopher.browser.terminal.KeyBindingManager')
    def test_init_with_session_manager_error(self, mock_0):
    ...
    @patch.object(GopherBrowser, 'setup_keybindings', return_value=None)
    @patch('modern_gopher.browser.terminal.Application')
    def test_navigate_to_with_plugin_processing(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_navigate_to_with_plugin_processing_error(self, mock_0):
    ...
    def test_navigate_to_html_content(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.SessionManager')
    @patch('modern_gopher.browser.terminal.render_html_to_text')
    def test_navigate_to_html_rendering_error(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_navigate_to_binary_content(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_navigate_to_binary_content_no_plugins(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_navigate_to_protocol_error(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_open_selected_item(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_open_selected_item_no_items(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_go_back_no_history(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_go_forward(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_get_browser_state(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_restore_browser_state(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_restore_browser_state_error(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_auto_restore_session_disabled(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_auto_restore_session_success(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_auto_restore_session_no_session(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_show_session_dialog_no_sessions(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_show_session_dialog_with_sessions(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_auto_save_session_on_exit(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_run_with_session_restore(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_run_keyboard_interrupt(self, mock_0):
    ...
    @patch('modern_gopher.browser.terminal.Application')
    @patch('modern_gopher.browser.terminal.SessionManager')
    def test_run_unexpected_error(self, mock_0):
