...
class TestModernGopherConfig:
    ...
    def test_path_expansion(self):
        ...
        config = ModernGopherConfig(
            ...
            bookmarks_file='~/test-bookmarks.json'
        )
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            config = ModernGopherConfig(
                cache_directory=os.path.join(
                    temp_dir, 'cache'), bookmarks_file=os.path.join(
                    temp_dir, 'config', 'bookmarks.json'))
    ...
    def test_get_config_validation_and_directories(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            custom_config = ModernGopherConfig(
                cache_directory=os.path.join(
                    temp_dir, 'custom_cache'), bookmarks_file=os.path.join(
                    temp_dir, 'custom_config', 'bookmarks.json'))
            custom_config.save(config_path)
...
class TestDefaultConfig:
    ...
    def test_default_config_values(self):
        ...
        # Gopher defaults
        assert DEFAULT_CONFIG['gopher']['default_server'].startswith(
            'gopher://')
