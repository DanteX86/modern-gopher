...
from modern_gopher.core.protocol import GopherTimeoutError
from modern_gopher.core.protocol import create_socket
from modern_gopher.core.protocol import is_gopher_url
from modern_gopher.core.protocol import receive_response
from modern_gopher.core.protocol import request_gopher_resource
from modern_gopher.core.protocol import save_gopher_resource
from modern_gopher.core.protocol import send_request
...
class TestResourceRequests:
    ...
    def test_request_gopher_resource_success(
            self, mock_receive, mock_send, mock_create_socket):
    ...
    @patch('modern_gopher.core.protocol.create_socket')
    def test_request_gopher_resource_connection_failure(
            self, mock_create_socket):
        """Test resource request with connection failure."""
        mock_create_socket.side_effect = GopherConnectionError(
            "Connection failed")
    ...
    def test_save_gopher_resource(self, mock_request):
        ...
        mock_request.assert_called_once_with(
            'localhost', '/test', 70, False, 30, None, 4096
        )
