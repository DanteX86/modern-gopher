...
class TestBookmarkManager:
    ...
    def test_search_bookmarks(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Add test bookmarks
            manager.add("gopher://python.org", "Python Documentation", "Official Python docs", ["python", "docs"])
            manager.add("gopher://golang.org", "Go Documentation", "Official Go docs", ["go", "docs"])
    ...
    def test_export_import(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Should import the 2 test bookmarks plus any defaults that weren't already there
